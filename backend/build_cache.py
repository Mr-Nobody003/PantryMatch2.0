...
try:
    ...
    # Simply importing pyplot often triggers font cache building, but doing a dummy plot ensures it.
    fig, ax = plt.subplots()
...
try:
    ...
    # This automatically downloads yolov8n.pt if it doesn't exist
